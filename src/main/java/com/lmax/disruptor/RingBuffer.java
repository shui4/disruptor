 ...
 * between event producer and {@link EventProcessor}s.
 *
 * @param <E> implementation storing the data for sharing during exchange or parallel coordination
 *     of an event.
 */
public final class RingBuffer<E> extends RingBufferFields<E>
  ...
  /**
   * Create a new multiple producer RingBuffer using the default wait strategy {@link
  ...
  /**
   * Add the specified gating sequences to this instance of the Disruptor. They will safely and
   * atomically added to the list of gating sequences.
   *
   ...
   * This can cause a data race and should only be done in controlled circumstances, e.g. during
   * initialisation.
   *
   ...
   *
   * <p>This call has 2 uses. Firstly use this call when publishing to a ring buffer. After calling
   * {@link RingBuffer#next()} use this call to get hold of the preallocated event to fill with data
   * before calling {@link RingBuffer#publish(long)}.
   *
   * <p>Secondly use this call when consuming data from the ring buffer. After calling {@link
   * SequenceBarrier#waitFor(long)} call this method with any value greater than that your current
   * consumer sequence and less than or equal to the value returned from the {@link
   * SequenceBarrier#waitFor(long)} method.
   *
   ...
   * Note, you can not assume that if this method returns <tt>true</tt> that a call to {@link
   * RingBuffer#next()} will not block. Especially true if this ring buffer is set up to handle
   * multiple producers.
   *
   * @param requiredCapacity The capacity to check for.
   * @return <tt>true</tt> If the specified <tt>requiredCapacity</tt> is available <tt>false</tt> if
   *     not.
   */
  ...
  /**
   * Increment and return the next sequence for the ring buffer. Calls of this method should ensure
   * that they always publish the sequence afterward. E.g.
   *
   * <pre>
  ...
  /**
   * The same functionality as {@link RingBuffer#next()}, but allows the caller to claim the next n
   * sequences.
   *
  ...
  /**
   * Publish the specified sequence. This action marks this particular message as being available to
   * be read.
   *
   ...
   * </pre>
   *
   * <p>This method will not block if there is not space available in the ring buffer, instead it
  ...
  /**
   * The same functionality as {@link RingBuffer#tryNext()}, but allows the caller to attempt to
   * claim the next n sequences.
   *
   * @param n number of slots to claim
   * @return sequence number of the highest slot claimed
   * @throws InsufficientCapacityException if the necessary space in the ring buffer is not
  ...
  /**
   * Get the current cursor value for the ring buffer. The actual value received will depend on the
   * type of {@link Sequencer} that is being used.
   *
   * @see MultiProducerSequencer
   * @see SingleProducerSequencer
   */
  ...
  /**
   * Determines if a particular entry is available. Note that using this when not within a context
   * that is maintaining a sequence barrier, it is likely that using this to determine if you can
   * read a value is likely to result in a race condition and broken code.
   *
  ...
  /**
   * Create a new SequenceBarrier to be used by an EventProcessor to track which messages are
   * available to be read from the ring buffer given a list of sequences to track.
   *
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.EventTranslatorOneArg,
   *     Object) com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.EventTranslatorOneArg,
   *     A)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.EventTranslatorTwoArg,
   *     Object, Object)
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.EventTranslatorThreeArg,
   *     Object, Object, Object)
   *     com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.EventTranslatorThreeArg, A, B,
   *     C)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.EventTranslatorVararg,
   *     java.lang.Object...)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorOneArg,
   *     Object[])
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorOneArg, int,
   *     int, Object[])
   *     com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorOneArg, int,
   *     int, A[])
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorTwoArg,
   *     Object[], Object[])
   *     com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorTwoArg, A[],
   *     B[])
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorTwoArg, int,
   *     int, Object[], Object[])
   *     com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorTwoArg, int,
   *     int, A[], B[])
   */
  @Override
  public <A, B> void publishEvents(
      EventTranslatorTwoArg<E, A, B> translator,
      int batchStartsAt,
      int batchSize,
      A[] arg0,
      B[] arg1) {
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorThreeArg,
   *     Object[], Object[], Object[])
   *     com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorThreeArg, A[],
   *     B[], C[])
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorThreeArg,
   *     int, int, Object[], Object[], Object[])
   *     com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorThreeArg, int,
   *     int, A[], B[], C[])
   */
  @Override
  public <A, B, C> void publishEvents(
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorVararg,
   *     java.lang.Object[][])
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.EventTranslatorVararg, int,
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.EventTranslatorOneArg,
   *     Object)
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.EventTranslatorTwoArg,
   *     Object, Object)
   *     com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.EventTranslatorTwoArg, A,
   *     B)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.EventTranslatorThreeArg,
   *     Object, Object, Object)
   *     com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.EventTranslatorThreeArg, A,
   *     B, C)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.EventTranslatorVararg,
   *     java.lang.Object...)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslator[], int,
   *     int)
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorOneArg,
   *     Object[])
   *     com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorOneArg,
   *     A[])
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorTwoArg,
   *     Object[], Object[])
   *     com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorTwoArg,
   *     A[], B[])
   */
  @Override
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorThreeArg,
   *     Object[], Object[], Object[])
   *     com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorThreeArg,
   *     A[], B[], C[])
   */
  @Override
  ...
  public <A, B, C> boolean tryPublishEvents(
    ...
    try {
      ...
      translateAndPublishBatch(
          translator, arg0, arg1, arg2, batchStartsAt, batchSize, finalSequence);
      return true;
    } catch (InsufficientCapacityException e) {
      return false;
    }
  ...
  /**
   * @see com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.EventTranslatorVararg,
   *     java.lang.Object[][])
   */
  @Override
  ...
  private void translateAndPublishBatch(
      final EventTranslatorVararg<E> translator,
      int batchStartsAt,
      final int batchSize,
  ...
  private <A, B> void checkBounds(
      final A[] arg0, final B[] arg1, final int batchStartsAt, final int batchSize) {
    checkBatchSizing(batchStartsAt, batchSize);
    batchOverRuns(arg0, batchStartsAt, batchSize);
    batchOverRuns(arg1, batchStartsAt, batchSize);
  }
  ...
  private <A, B> void translateAndPublishBatch(
      final EventTranslatorTwoArg<E, A, B> translator,
      final A[] arg0,
      final B[] arg1,
      int batchStartsAt,
      int batchSize,
  ...
  private <A> void translateAndPublishBatch(
      final EventTranslatorOneArg<E, A> translator,
      final A[] arg0,
      int batchStartsAt,
      final int batchSize,
      final long finalSequence) {
  ...
  private void checkBounds(
      final EventTranslator<E>[] translators, final int batchStartsAt, final int batchSize) {
    checkBatchSizing(batchStartsAt, batchSize);
    batchOverRuns(translators, batchStartsAt, batchSize);
  }

  private void translateAndPublishBatch(
      final EventTranslator<E>[] translators,
      int batchStartsAt,
      final int batchSize,
      final long finalSequence) {
    final long initialSequence = finalSequence - (batchSize - 1);
  ...
  private void checkBatchSizing(int batchStartsAt, int batchSize) {
    if (batchStartsAt < 0 || batchSize < 0) {
      throw new IllegalArgumentException(
          "Both batchStartsAt and batchSize must be positive but got: batchStartsAt "
              + batchStartsAt
              + " and batchSize "
              + batchSize);
  ...
  private void translateAndPublish(
      EventTranslatorVararg<E> translator, long sequence, Object... args) {
    try {
  ...
  private <A, B, C> void translateAndPublish(
      EventTranslatorThreeArg<E, A, B, C> translator, long sequence, A arg0, B arg1, C arg2) {
    try {
