...
public final class Util {
  ...
  /**
   * Get a handle on the Unsafe instance, used for accessing low-level concurrency and memory
   * constructs.
   *
   * @return The Unsafe
   */
  ...
  /**
   * Calculate the log base 2 of the supplied integer, essentially reports the location of the
   * highest bit.
   *
