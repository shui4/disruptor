 ...
 * </pre>
 *
 * <p>Note: <b>This test is only useful on a system using an invariant TSC in user space from the
 * System.nanoTime() call.</b>
 */
public final class PingPongQueueLatencyTest {
  ...
  private final QueuePinger qPinger =
      new QueuePinger(pingQueue, pongQueue, ITERATIONS, PAUSE_NANOS);
  ...
  private static class QueuePinger implements Runnable {
    ...
    QueuePinger(
        final BlockingQueue<Long> pingQueue,
        final BlockingQueue<Long> pongQueue,
    ...
    public void reset(
        final CyclicBarrier barrier, final CountDownLatch latch, final Histogram histogram) {
