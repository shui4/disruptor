...
public class DisruptorStressTest {
  ...
  public void shouldHandleLotsOfThreads() throws Exception {
    ...
    Publisher[] publishers =
        initialise(new Publisher[publisherCount], ringBuffer, iterations, barrier, latch);
  ...
  private TestEventHandler[] initialise(
      Disruptor<TestEvent> disruptor, TestEventHandler[] testEventHandlers) {
  ...
  private static class TestEvent {
    public static final EventFactory<TestEvent> FACTORY =
        new EventFactory<DisruptorStressTest.TestEvent>() {
          @Override
