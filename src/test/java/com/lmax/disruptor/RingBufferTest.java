...
public class RingBufferTest {
  ...
  private final RingBuffer<StubEvent> ringBuffer =
      RingBuffer.createMultiProducer(StubEvent.EVENT_FACTORY, 32);
  ...
  public void shouldClaimAndGet() throws Exception {
    ...
    ringBuffer.publishEvent(
        StubEvent.TRANSLATOR, expectedEvent.getValue(), expectedEvent.getTestString());
  ...
  public void shouldNotPublishEventsIfBatchIsLargerThanRingBuffer() throws Exception {
    ...
    final EventTranslator<Object[]>[] translators =
        new EventTranslator[] {
          eventTranslator, eventTranslator, eventTranslator, eventTranslator, eventTranslator
        };
  ...
  public void shouldNotPublishEventsVarArgWhenBatchExtendsPastEndOfArray() throws Exception {
    ...
    try {
      ringBuffer.publishEvents(
          ...
          1,
          3,
          new String[] {"Foo0", "Bar0", "Baz0", "Bam0"},
  ...
  public void shouldNotPublishEventsWhenBatchSizeIs0() throws Exception {
    ...
    try {
      ringBuffer.publishEvents(
          new EventTranslator[] {translator, translator, translator, translator}, 1, 0);
    } finally {
      assertEmptyRingBuffer(ringBuffer);
    }
  }
  ...
  public void shouldNotPublishEventsWhenBatchSizeIsNegative() throws Exception {
    ...
    try {
      ringBuffer.publishEvents(
          new EventTranslator[] {translator, translator, translator, translator}, 1, -1);
    } finally {
      assertEmptyRingBuffer(ringBuffer);
    }
  }
  ...
  public void shouldNotPublishEventsWhenBatchStartsAtIsNegative() throws Exception {
    ...
    try {
      ringBuffer.publishEvents(
          new EventTranslator[] {translator, translator, translator, translator}, -1, 2);
    } finally {
      assertEmptyRingBuffer(ringBuffer);
    }
  }
  ...
  public void shouldPreventPublishersOvertakingEventProcessorWrapPoint()
    ...
    final RingBuffer<StubEvent> buffer2 =
        createMultiProducer(StubEvent.EVENT_FACTORY, ringBufferSize);
  ...
  public void shouldPublishEventsOneArgBatchSizeOfOne() throws Exception {
    ...
    assertThat(
        ringBuffer,
        ringBufferWithEvents(
            is((Object) "Foo-0"), is((Object) "Foo-1"), is(nullValue()), is(nullValue())));
  }
  ...
  public void shouldPublishEventsThreeArgBatchSizeOfOne() throws Exception {
    ...
    assertThat(
        ringBuffer,
        ringBufferWithEvents(
            is((Object) "FooBarBaz-0"),
            is((Object) "FooBarBaz-1"),
            is(nullValue()),
            is(nullValue())));
  }
  ...
  public void shouldPublishEventsThreeArgWithinBatch() throws Exception {
    ...
    ringBuffer.publishEvents(
        ...
        1,
        2,
        new String[] {"Foo0", "Foo1", "Foo2"},
        new String[] {"Bar0", "Bar1", "Bar2"},
    ...
    assertTrue(
        ringBuffer.tryPublishEvents(
            ...
            1,
            2,
            new String[] {"Foo3", "Foo4", "Foo5"},
            new String[] {"Bar3", "Bar4", "Bar5"},
  ...
  public void shouldPublishEventsTwoArg() throws Exception {
    ...
    ringBuffer.tryPublishEvents(
        translator, new String[] {"Foo", "Foo"}, new String[] {"Bar", "Bar"});
  ...
  public void shouldPublishEventsTwoArgWithBatchSizeOfOne() throws Exception {
    ...
    ringBuffer.publishEvents(
        translator, 0, 1, new String[] {"Foo0", "Foo1"}, new String[] {"Bar0", "Bar1"});
    ringBuffer.tryPublishEvents(
        translator, 0, 1, new String[] {"Foo2", "Foo3"}, new String[] {"Bar2", "Bar3"});

    assertThat(
        ringBuffer,
        ringBufferWithEvents(
            is((Object) "Foo0Bar0-0"),
            is((Object) "Foo2Bar2-1"),
            is(nullValue()),
            is(nullValue())));
  }
  ...
  public void shouldPublishEventsTwoArgWithinBatch() throws Exception {
    ...
    assertThat(
        ringBuffer, ringBufferWithEvents("Foo1Bar1-0", "Foo2Bar2-1", "Foo4Bar4-2", "Foo5Bar5-3"));
  }
  ...
  public void shouldPublishEventsVarArgBatchSizeOfOne() throws Exception {
    ...
    assertThat(
        ringBuffer,
        ringBufferWithEvents(
            is((Object) "FooBarBazBam-0"),
            is((Object) "FooBarBazBam-1"),
            is(nullValue()),
            is(nullValue())));
  }
  ...
  public void shouldPublishEventsVarArgWithinBatch() throws Exception {
    ...
    assertTrue(
        ringBuffer.tryPublishEvents(
            ...
            1,
            2,
            new String[] {"Foo3", "Bar3", "Baz3", "Bam3"},
  ...
  public void shouldPublishEventsWithBatchSizeOfOne() throws Exception {
    ...
    assertThat(
        ringBuffer,
        ringBufferWithEvents(is((Object) 0L), is((Object) 1L), is(nullValue()), is(nullValue())));
  }
  ...
  private static class ThreeArgEventTranslator
      implements EventTranslatorThreeArg<Object[], String, String, String> {
    @Override
  ...
  private static class TwoArgEventTranslator
      implements EventTranslatorTwoArg<Object[], String, String> {
    @Override
